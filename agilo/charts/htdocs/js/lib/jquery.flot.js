...
(function($) {
    function Plot(target, data_, options_, plugins) {
        ...
        function setupGrid() {
            ...
            if (options.grid.show || options.pies.show)
                insertLabels();
        ...
        function drawMyPieSeries(series) {
            ...
            for (j = 0; j < series.length; j++) {
                ...
                var html = "<div style=\"position: absolute;zindex:11; width:" + labelWidth + "px;fontSize:" + fontSize + "px;overflow:hidden;top:"+ top + ";left:"+ left + ";textAlign:" + textAlign + ";verticalAlign:" + verticalAlign +";color:#545454;font-size:smaller;\">" +  textVal + "%</div>";
        ...
        function drawSeriesBars(series) {
            ...
            var barOffsets = [barLeft, barRight];
            executeHooks(hooks.barOffsets, [series, barOffsets]);
            var fillStyleCallback = series.bars.fill ? function (bottom, top) { return getFillStyle(series.bars, series.color, bottom, top); } : null;
            plotBars(series.datapoints, barOffsets[0], barOffsets[1], 0, fillStyleCallback, series.xaxis, series.yaxis);
            ctx.restore();
        }
