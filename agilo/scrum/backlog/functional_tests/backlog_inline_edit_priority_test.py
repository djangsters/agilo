...
class CanEditPriorityInlineTest(AgiloFunctionalTestCase):
    testtype = 'windmill'
    ...
    def setUp(self):
        ...
        self.story = self.create_story('Story without sprint')
    ...
    def runTest(self):
        ...
        new_backlog.update_priority_for_ticket(self.story.id, 'Mandatory')
        new_backlog.update_priority_for_ticket(self.story.id, 'Exciter')
        new_backlog.update_priority_for_ticket(self.story.id, '')
